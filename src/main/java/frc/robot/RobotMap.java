...
public final class RobotMap {
  ...
  public static final class Drivetrain {
    public static final int FRONT_LEFT_TALON = 20;
    public static final int BACK_LEFT_TALON = 21;
    public static final int FRONT_RIGHT_TALON =  23;
    public static final int BACK_RIGHT_TALON = 22;
